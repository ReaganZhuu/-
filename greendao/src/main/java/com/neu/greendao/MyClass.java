...
public class MyClass {
    public static void main(String[] args) {
        ...
        Schema schema=new Schema(1000,"com.neu.rememberwords.greendao.entity.greendao");
        //添加需要创建的实体类信息
        addNote(schema);
        try {
            new DaoGenerator().generateAll(schema,"./RememberWords/src/main/java");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /**
     * 添加将要创建的实体类的信息，会根据类名生成数据库的表，根据属性名生成数据库的字段
